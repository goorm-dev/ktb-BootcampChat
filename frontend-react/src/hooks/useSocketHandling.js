...
export const useSocketHandling = (roomId, maxRetries = 5) => { // 최대 재시도 횟수 증가
  ...
  }, [retryCount, maxRetries, cleanup, getRetryDelay, roomId]);
  ...
  }, [isReconnecting, cleanup, getRetryDelay, maxRetries, roomId, handleConnectionError]);
